      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          <Input
            ...
            title="2 to 10 uppercase letters or numbers, starting with a letter"
          />
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1.5">
            Used for issue keys: {key || 'PROJ'}-1, {key || 'PROJ'}-2...
          </p>
        </div>
        ...
        <div>
          ...
          <textarea
            id="description"
            name="description"
            className="h-20 w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 transition-[border-color,box-shadow] duration-150 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:placeholder:text-gray-500 resize-none"
